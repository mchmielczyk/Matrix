...
//bool operator==(const Matrix<C>& M1, const Matrix<C>& M2) {
...
//
//template<typename U>
//Matrix<U> Transpose(const Matrix<U>& M) {
//    Matrix<U> res(M.cols, M.rows);
//    for (int i = 0; i < M.rows; i++) {
//        for (int j = 0; j < M.cols; j++) {
...
//
//template<typename U>
//Matrix<U> Inverse(Matrix<U>& M)
//{
//    Matrix<U> tmp(M.rows, M.cols);
//    for (int i = 0; i < M.rows; i++)
//    {
//        for (int j = 0; j < M.cols; j++)
//        {
